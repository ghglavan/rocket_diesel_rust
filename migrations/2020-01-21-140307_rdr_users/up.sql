...
GRANT USAGE, SELECT ON SEQUENCE rdr_users_in_groups_id_seq TO rdr_user;
GRANT USAGE, SELECT ON SEQUENCE rdr_posts_id_seq TO rdr_user;
GRANT USAGE, SELECT ON SEQUENCE rdr_follows_id_seq TO rdr_user;
GRANT USAGE, SELECT ON SEQUENCE rdr_tags_in_posts_id_seq TO rdr_user;
GRANT USAGE, SELECT ON SEQUENCE rdr_comments_id_seq TO rdr_user;
GRANT USAGE, SELECT ON SEQUENCE rdr_rating_id_seq TO rdr_user;